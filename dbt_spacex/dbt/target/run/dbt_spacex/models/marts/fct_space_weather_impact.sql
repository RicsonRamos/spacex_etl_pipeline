  ...
  create  table "spacex_db"."public_gold"."fct_space_weather_impact__dbt_tmp"
...
WITH launches AS (
    SELECT 
        ...
        launch_at_utc,
        is_success
    FROM "spacex_db"."public"."stg_spacex__launches"
),
...
solar_events AS (
    ...
    FROM "spacex_db"."public"."stg_nasa__solar_events"
)
